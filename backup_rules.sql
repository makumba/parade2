...
INSERT INTO `PercolationRule` VALUES (1,'FILE','versionOf','CVSFILE',10,'is the exact copy of the version on the cvs repository',''),(2,'FILE','dependsOn','FILE',20,'depends on the file that was acted upon',''),(3,'USER','save','FILE',0,'User watched file',''),(4,'CVSFILE','dependsOn','CVSFILE',20,'A cvs file depends on another cvs file','\0'),(5,'CVSFILE','checkedOutAs','FILE',10,'is the checked out version of a file in cvs','');
...
INSERT INTO `PercolationRule__relationQueries` VALUES (2,5),(2,1),(5,5),(4,5),(4,4),(1,4);
