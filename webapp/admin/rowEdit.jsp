...
<table >
<tr><td><strong>Row owner</strong></td>
<td>
...
<tr>
  <td><strong>Who does Unison (or any other external synchronisation) on this row at the moment</strong></td>
<td>
  <mak:input field="externalUser"> 
...
<tr>
  <td colspan="2" align="middle"><input type="submit" value="Save">&nbsp;&nbsp;<input type="button" value="Back" onClick="javascript:back();"></td>
</tr>
</table>
</mak:editForm>
</mak:object>
