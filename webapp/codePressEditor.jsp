...
<form name="sourceEdit" method="post"
  action="/File.do?op=saveFile&context=${context}&path=${path}&file=${file}&editor=codepress" style="margin: 0px;">
...
<textarea id="myCpWindow" class="codepress java" style="width: 100%; height: 92%" cols="90" rows="23" wrap="virtual"
  STYLE="font-face:Lucida Console; font-size:8pt">${fileEditorBean.content}</textarea> <input name="source" type="hidden"></input> <script
