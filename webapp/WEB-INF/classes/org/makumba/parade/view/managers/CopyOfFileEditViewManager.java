...
public class CopyOfFileEditViewManager implements FileEditorView {

    static Logger logger = Logger.getLogger(CopyOfFileEditViewManager.class.getName());
    ...
    public String getFileEditorView(Row r, String path, File file, String[] source) {
        ...
        out
                .println("<html><head>\n"
                        ...
                        + "<form name=\"sourceEdit\" method=\"post\" action=\"/servlet/edit?context="
                        + r.getRowname()
                        + "&path="
                        + path
                        + "&file="
                        ...
                        + "<a href='/servlet/browse?display=file&context="
                        + r.getRowname()
                        + "' target='directory' title='"
                        + r.getParade().getBaseDir()
                        + "'>\n"
                        + (r.getRowname().equals("") ? "(root)" : r.getRowname())
                        + "</a>:<a href=/servlet/browse?display=file&context="
                        + r.getRowname()
                        + "&path="
                        + r.getRowpath()
                        + path
                        ...
                        + "onKeyPress=\"javascript:setModified()\" STYLE=\"font-face:Lucida Console; font-size:8pt\">"
                        + content + "</textarea>" +
