...
<% String username = (String) ((HttpServletRequest) request).getSession(true).getAttribute("org.makumba.parade.user");
  String name = "";
...
Hi ${username}! It looks like ParaDe doesn't know you that well yet.<br>
