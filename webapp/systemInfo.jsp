...
<h2>Server info</h2>
Server is up since: <b><%=System.getProperty(startupProp)%></b> (<%=org.makumba.parade.tools.DisplayFormatter.readableTime( (new Date()).getTime() - new Date(System.getProperty(startupProp)).getTime() )%> ago)
