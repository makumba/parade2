...
<html>
<head>
<title>Edit user information of ${user_nickname}</title>
</head>
<body>
<h2>Hi ${user_name}!</h2>
...
<mak:object from="User u" where="u.login=:user_login">
	<mak:form action="userView.jsp" method="post"
		...
		<mak:editForm object="u">
			<table>
				...
				<tr>
					<td>Mentor</td>
					<td><mak:input field="mentor">
						<mak:option>--Pick one--</mak:option>
						<mak:list from="User m" orderBy="m.name, m.surname">
							<mak:option value="m.id">
								<mak:value expr="m.name" />
								<mak:value expr="m.surname" /> (<mak:value expr="m.nickname" />) </mak:option>
						</mak:list>
					</mak:input></td>
				</tr>
				<mak:list from="Row r" where="r.user = u">
					<mak:editForm object="r">
						<tr>
							...
							<td><mak:input field="automaticCvsUpdate" /> (this means
							that if one file is committed by someone and you didn't touch it,
							ParaDe will CVS update it for you)</td>
						</tr>
					</mak:editForm>
				</mak:list>
				<tr>
